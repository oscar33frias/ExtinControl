...
export const emailRegistro = async (datos) => {
  ...
  const info = await transport.sendMail({
   ...
   html: `
    ...
    <a href="${process.env.FRONTEND_URL_TRABAJO}/confirmar/${token}">Confirmar cuenta</a>
    `,
...
export const emailOlvidePassword = async (datos) => {
  ...
  const info = await transport.sendMail({
   ...
   html: `
    ...
    <a href="${process.env.FRONTEND_URL_TRABAJO}/olvide-password/${token}">Confirmar cuenta</a>
    `,
