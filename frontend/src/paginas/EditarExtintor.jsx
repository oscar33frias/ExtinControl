...
const EditarExtintor = () => {
  ...
  const { obtenerExtintor, extintor, cargando, eliminarExtintor } =
    useExtintores();
  ...
  const handleClick = () => {
    if (confirm("¿Estás seguro de eliminar el extintor?")) {
      eliminarExtintor(extintor.id);
    }
  };
    ...
    <div className="bg-gray-200 min-h-screen py-12">
      <div className="w-full mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between">
          <h1 className="font-black text-5xl text-red-700 text-center mb-16">
            Edita el extintor: {codigo}
          </h1>{" "}
